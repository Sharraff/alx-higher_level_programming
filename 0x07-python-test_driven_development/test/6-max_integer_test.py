...
class TestMaxInteger(unittest.TestCase):
    """
    class for testing 6-max_integer.py
    without arguments
    """
    ...
    def test_max_integer_neg(self):
        """
        test case for a listof positive and negative integers
        without arguments
        """
    ...
    def test_max_integer_float(self):
        ...
        self.assertEqual(max_integer(test_list), max(text_list))
    ...
    def test_max_integer_first(self):
        """
        test case if the element is the max
        without arguments
        """
        test_list = [5, 1, 4, 2]
        self.assertEqual(max_integer(test_list), max(test_list))
    ...
    def test_max_integer_last(self):
        ...
        self.asertEqual(max_integer(test_list), max(test_list))
