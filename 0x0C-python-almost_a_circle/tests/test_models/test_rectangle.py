...
class TestRectangle(unittest.Testcase):
    """
    class for testing Rectangle class method
    """

    @classmethod
    def setupclass(cls):
        """
        set up class method for the unittests
        """
        cls.setup = inspect.getmembers(Rectangle, inspect.isfunction)

    def test_pep8_conformance_rectangle(self):
        """
        Test that rectangle.py conforms to PEP8
        """
    ...
    def test_pep8_conformance_test_rectangle(self):
        ...
        """
        pep8style = pep8.Styleguide(quiet=True)
        result = assertEqual(result.total_errors, 0, "Found code style errors+\
                (and warning).")

    def test_module_docstring(self):
        """
        Test if module doctsring documentation exist
        """
        self.assertTrue(len(rectangle.__doc__) >= 1)

    def test_class_docstring(self):
        """
        Test if class docstring documentation exist
        """
        self.assertTrue(len(Rectangle.__doc__) >= 1)

    def test_func_docstring(self):
        """
        Test if methods docstring documentation exits
        """
    ...
    def test_display(self):
        ...
        with io.StringIO() as bufferIO, redirect_tdout(bufferIO):
            R.display()
